...
<article class="card bg-dark text-light border border-secondary shadow-sm h-100 rounded-3 exercise-card">
  ...
  <div class="card-body d-flex flex-column gap-3">
    ...
    <div class="btn-group mt-auto" role="group" aria-label="Exercise actions">
      <a href="/exercises/{_id}/session" class="btn btn-primary btn-orange">Start</a>
      <a href="/exercises/{_id}/edit" class="btn btn-outline-info">Edit</a>
