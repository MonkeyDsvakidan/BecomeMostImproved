      ...
      <div class="card bg-dark text-light border border-secondary shadow-lg rounded-3">
        <div class="card-body p-4 p-md-5">
          <div class="d-flex flex-column gap-2 mb-4">
            ...
            <p class="text-secondary mb-0">Build a workout by selecting exercises and setting pace.</p>
          </div>
          ...
          <form on:submit|preventDefault={handleSubmit} class="d-flex flex-column gap-4">
            ...
            <div class="form-floating">
              <input id="name" class={`form-control bg-dark text-light border-secondary ${submitted && !form.name.trim() ? 'is-invalid' : ''}`} type="text" bind:value={form.name} placeholder="e.g., Morning Strength Training" required />
