...
<section class="session">
	...
	{:else if error}
		...
		<a href={resolve('/exercises')} class="btn-back">Back to Exercises</a>
	{:else if exercise}
		{#if !isFinished}
			...
			<div class="controls">
				<button class="btn-pause" on:click={togglePause} disabled={timeRemaining === 0}>
					{isPaused ? 'Resume' : 'Pause'}
				</button>
				<button class="btn-finish" on:click={handleFinish}> Finish Exercise </button>
			</div>
		{:else}
